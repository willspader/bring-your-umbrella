...
import com.github.willspader.`type`.Types.WheaterResponse
...
object OWMHttpClient {
  ...
  def getDailyWheater(): Identity[Response[Either[ResponseError[Exception], WheaterResponse]]] = {
    ...
    basicRequest.get(uri"https://api.openweathermap.org/data/2.5/onecall?lat=-30.03306&lon=-51.23&appid=$apiKey")
      .response(asJson[WheaterResponse])
      .send()
  }
